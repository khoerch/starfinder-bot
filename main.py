...
text_on_mystic = """
Mystic
Source Starfinder Core Rulebook pg. 82
...
query = f"""Use the below article on the Starfinder Mystic to answer the subsequent question. If the answer cannot be found, write "I don't know."
...
Question: How does my wisdom score effect that?"""

response = openai.ChatCompletion.create(
    messages=[
        {'role': 'system', 'content': 'You answer questions about the Starfinder RPG rules.'},
